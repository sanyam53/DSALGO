package com.tolani.SegmentTreeFor;
...
public class SegmentTree {
    ...
    public int[] createSegmentTree(int input[]){
        ...
        int segTreeSize = 2 * (int) Math.pow(2, height) - 1;
    ...
    public static void main(String args[]){
        ...
        int b = st.rangeMinimumQuery(segTree, 0, 3, input.length);
        b = st.rangeMinimumQuery(segTree, 1, 5, input.length);
        b= st.rangeMinimumQuery(segTree, 1, 6, input.length);
        st.updateSegmentTree(input, segTree, 2, 1);
        b= st.rangeMinimumQuery(segTree, 1, 3, input.length);
        st.updateSegmentTreeRange(input, segTree, 3, 5, -2);
        b= st.rangeMinimumQuery(segTree, 5, 6, input.length);
        b= st.rangeMinimumQuery(segTree, 0, 3, input.length);
        ...
        int a = st.rangeMinimumQueryLazy(segTree1, lazy1, 6, 7, input1.length);
